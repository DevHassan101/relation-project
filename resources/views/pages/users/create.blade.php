<x-app-layout>
    ...
    <div class=" bg-white border border-gray-300 rounded-2xl">
        <form class="bg-white rounded px-3 pt-6 pb-4 mb-4" action="{{ route('users.store') }}" method="post"
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div class="">
                    ...
                    <input type="date" id="date" name="dob" class="border rounded w-full py-2 px-3 text-gray-700" value="{{ old('dob', date('Y-m-d')) }}"
            ...
            <div class="">
                ...
                <textarea id="address" name="address" rows="6" placeholder="Write address here"
                    class="w-full p-2 border rounded-md text-black dark:border-gray-500">{{ old('address') }}</textarea>
            </div>
